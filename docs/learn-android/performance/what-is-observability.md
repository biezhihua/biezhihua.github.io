...
# Android | 性能优化 | 可观测技术 - Observable Technology

## 什么是可观测技术？- What is Observable Technology?
...
## 为什么可观测技术很重要？- Why is Observable Technology important?
...
## Android中的的可观测技术 - Observable Technology in Android
...
## Android中用于收集和分析各种类型的数据的工具 - Tools for collecting and analyzing various types of data in Android

### 可用工具概览 - Overview of available tools
...
#### [Traceview](https://developer.android.com/studio/profile/traceview) **（Traceview is deprecated）**:
